...
export function FormRView({ formType }: Readonly<UnifiedFormRViewProps>) {
  ...
  const formConfig = useMemo(() => {
    ...
    const validationSchemaForView = getFormBValidationSchema(activeCovid);
    ...
    return { formJson: finalFormJson, validationSchemaForView };
  ...
  return (
    <FormRReviewView
      formData={formData}
      formJson={formConfig.formJson}
      validationSchemaForView={formConfig.validationSchemaForView}
    />
  );
}
