...
export const mockPlacements: Placement[] = [
  {
    ...
    subSpecialty: { subSpecialty: "Sub Specialty", postAllowsSubspecialty: true },
...
export const mockPlacementsForGrouping: Placement[] = [
  // Past
  {
    ...
    subSpecialty: { subSpecialty: "subSpecialty1", postAllowsSubspecialty: true },
    grade: "grade1",
  ...
  // Current
  {
    ...
    subSpecialty: { subSpecialty: "subSpecialty2", postAllowsSubspecialty: true },
    grade: "grade2",
  ...
  // Upcoming
  {
    ...
    subSpecialty: { subSpecialty: "subSpecialty3", postAllowsSubspecialty: true },
    grade: "grade3",
  ...
  // Future
  {
    ...
    subSpecialty: { subSpecialty: "subSpecialty4", postAllowsSubspecialty: true },
    grade: "grade4",
