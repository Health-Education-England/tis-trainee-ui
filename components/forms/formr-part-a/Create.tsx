    ...
    <>
      ...
      >
        {({ values, errors, setFieldValue, isSubmitting }) => {
          const programmeSpecialtyOptions = combinedReferenceData.curriculum;
          const filteredProgrammeSpecialtyOptions =
            combinedReferenceData.curriculum.filter(
              (c: any) => c.curriculumSubType === MEDICAL_CURRICULUM
            );
          return (
            <Form
              onKeyDown={event => {
              ...
              <Card feature>
                <Card.Content>
                  ...
                  {values.declarationType === CCT_DECLARATION && (
                    <>
                      <AutocompleteSelect
                        value={values.cctSpecialty1}
                        onChange={setFieldValue}
                        error={errors.cctSpecialty1}
