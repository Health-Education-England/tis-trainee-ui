...
import { useFormRConfig } from "../useFormRConfig";
...
describe("useFormRConfig", () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });

  it("should select part-a config for non-PH", () => {
    ...
    const { result } = renderHook(() => useFormRConfig("A"));
  ...
  it("should select part-b config for non-PH", () => {
    const { useAppSelector } = require("../../../redux/hooks/hooks");
    const {
      selectAllReference
    } = require("../../../redux/slices/referenceSlice");
    ...
    const { result } = renderHook(() => useFormRConfig("B"));
  ...
  it("should select part-b-ph config for PH", () => {
    const { useAppSelector } = require("../../../redux/hooks/hooks");
    const {
      selectAllReference
    } = require("../../../redux/slices/referenceSlice");
