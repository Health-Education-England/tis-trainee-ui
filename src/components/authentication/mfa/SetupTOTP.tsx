      ...
      {qrCode !== "" && (
        <div>
          ...
          <WarningCallout label="Warning">
            <p>
              To keep your data secure, you have <strong>3 minutes</strong> to
              scan the QR code below using your Authenticator App on your phone
              and use the 6-digit code generated by your app before the{" "}
            ...
            >
              Click here for help setting-up an Authenticator App on your phone
