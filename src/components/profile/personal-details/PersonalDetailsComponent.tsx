...
const PersonalDetailsComponent: React.FC<IProps> = ({ personalDetails }) => {
  ...
  return (
    <Details.ExpanderGroup>
        ...
        <Details.Text>
          <SummaryList>
            <SummaryList.Row>
              ...
              <SummaryList.Value>
                {`${personalDetails.title} ${personalDetails.forenames} ${personalDetails.surname}`}
              </SummaryList.Value>
            </SummaryList.Row>
            {personalData &&
              personalData.map(pd => (
      ...
      <Details expander data-cy="registrationExpander">
        <Details.Summary>Registration details</Details.Summary>
        <Details.Text>
